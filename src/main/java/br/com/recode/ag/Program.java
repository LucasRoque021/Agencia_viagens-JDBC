...
public class Program {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("");
			System.out.println("______________________BEM-VINDO À LR VIAGENS______________________");
			System.out.println("");
			System.out.println("Digite uma das opções abaixo.");
			System.out.println("0 para SAIR");
			System.out.println("1 para CRUD CLIENTES");
			System.out.println("2 para CRUD DESTINOS");
			System.out.println("3 para CRUD PROMOÇÕES");
			System.out.println("4 para exibir DESTINOS E PROMOÇÕES");
			System.out.println("5 para exibir CLIENTES COM SEUS DESTINOS ESCOLHIDOS");
			opcao = sc.nextInt();
			
			switch (opcao) {
			case 0:
				System.out.println("Fechando MENU - LR VIAGENS.");
				repetir = false;
				break;
			case 1:
